...
import { CheckRecord, MaintenanceRecord, Asset } from '../types';
...
const Compliance: React.FC = () => {
  ...
  useEffect(() => {
    DataService.getChecks().then(setChecks);
    DataService.getMaintenanceRecords().then(setMaintenance);
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between no-print">
        <div className="flex items-center space-x-4 mb-4 md:mb-0">
            ...
            <div>
                <h2 className="text-2xl font-bold text-slate-800">มาตรฐาน & รายงาน (Reports & Compliance)</h2>
